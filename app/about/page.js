    ...
    <>
      <Layout headerStyle={1} footerStyle={1}>
        <div>
              ...
              <div className="row align-items-end justify-content-between">
                <div className="col-lg-8 wow fadeInLeft delay-0-2s">
                  <div className="about-hero-content pt-135 rpt-95 pb-95">
                    <h1>
                      We’re professional creative <span>agency</span>
                    </h1>
                    <p>
                      We work closely with our clients throughout the design
                      process, from the initial consultation to the final
                      delivery, to ensure that we meet their expectations and
                      exceed their goals.
                    </p>
            ...
            <div className="headline-wrap style-two">
              <span className="marquee-wrap for-arrow-icon">
                <span className="marquee-inner left">
                  ...
                  <span className="marquee-item">
                    <b>design - customer centric solution</b>
                    <i className="fal fa-long-arrow-right" />
                  </span>
                  <span className="marquee-item">
                    <b>web development based company</b>
          ...
          <section
            id="about"
            className="about-area bgc-black py-145 rpy-100 rel z-1"
          >
            <div className="container">
                ...
                <div className="col-lg-7">
                  <div className="about-content wow fadeInRight delay-0-2s">
                    <div className="section-title mb-30">
                      ...
                      <h2>
                        We’re a digital design studio connecting brands to
                        people <span>through</span> craft and culture.{" "}
            ...
            <div className="row justify-content-center">
              <div className="col-xl-4 col-sm-6">
                <div className="portfolio-item style-three wow fadeInUp delay-0-2s">
                  <div className="portfolio-image">
                    <img
                      src="/assets/images/portfolio/portfolio-three1.jpg"
                      alt="Portfolio"
                    />
                  </div>
                  ...
                  <div className="portfolio-content">
                    <h6>
                      <Link href="/portfolio-details">Digital Marketing</Link>
                    </h6>
                    <Link className="tag-category" href="/blog">
                      Art , Direction
                    </Link>
                  </div>
                </div>
              ...
              <div className="col-xl-4 col-sm-6">
                <div className="portfolio-item style-three wow fadeInUp delay-0-4s">
                  <div className="portfolio-image">
                    <img
                      src="/assets/images/portfolio/portfolio-three2.jpg"
                      alt="Portfolio"
                    />
                  </div>
                  <Link className="hover-box" href="/portfolio-details">
              ...
              <div className="col-xl-4 col-sm-6">
                <div className="portfolio-item style-three wow fadeInUp delay-0-6s">
                  <div className="portfolio-image">
                    <img
                      src="/assets/images/portfolio/portfolio-three3.jpg"
                      alt="Portfolio"
                    />
                  </div>
                  <Link className="hover-box" href="/portfolio-details">
          ...
          <div className="counter-two-area pt-45 pb-140">
            <div className="container">
              <span className="sub-title-style-two mb-40 wow fadeInUp delay-0-2s">
                we’re proud to work with a Wide range of companies
              </span>
              ...
              <div className="row gap-150 justify-content-between">
                <div className="col-lg-6 wow fadeInLeft delay-0-2s">
                  <div className="section-title mb-20">
                    ...
                    <Link href="/services" className="read-more-two mt-20">
                      What We Do{" "}
                ...
                <div className="col-lg-6 pt-35 wow fadeInRight delay-0-2s">
                  <div className="service-item-four">
                    <h5>
                      WEBSITE DEsign <span className="number">01</span>
                    </h5>
                    <p>
                      There are many variations of simply free text passages of
                      hold industry available but the majority have suffered
                      alteration
                    </p>
                    <Link href="/services" className="read-more-two">
                      Read More{" "}
                      <img src="/assets/images/icons/arrow.svg" alt="Arrow" />
                    </Link>
                  </div>
                  <div className="service-item-four">
                    <h5>
                      digital marketing <span className="number">02</span>
                    </h5>
                    <p>
                      There are many variations of simply free text passages of
                      hold industry available but the majority have suffered
                  ...
                  <div className="service-item-four">
                    <h5>
                      Content Solutions <span className="number">03</span>
                    </h5>
                    <p>
                      There are many variations of simply free text passages of
                      hold industry available but the majority have suffered
          ...
          <section className="team-area overflow-hidden pt-140 rpt-50 pb-120 rpb-70 rel z-1">
              ...
              <div className="row justify-content-center">
                <div className="col-xl-6 col-lg-8">
                  <div className="section-title text-center mb-70 wow fadeInUp delay-0-2s">
                    ...
                    <h2>
                      Extra ordinary <span>creation</span> Team behind
                    </h2>
                  </div>
                </div>
              </div>
            ...
            <div className="container container-1450">
                ...
                <div className="col-xl-3 col-lg-4 col-sm-6">
                  <div className="team-member style-two wow fadeInUp delay-0-2s">
                    ...
                    <div className="description">
                      ...
                      <Link href="/team-details" className="details-btn">
                        <i className="far fa-arrow-right" />
                      </Link>
              ...
              <div className="team-btn pt-30 text-center">
                <Link href="/team" className="theme-btn style-three">
                  Meet with team
                </Link>
              </div>
            </div>
          ...
          {/* FAQ Area start */}
          <section
            className="faq-area py-135 rpy-100 rel z-1 bgs-cover"
            style={{ backgroundImage: "url(assets/images/faqs/faq-bg.jpg)" }}
          >
            <div className="faq-section-inner rel">
              <div
                className="faq-image-part bgs-cover"
                style={{ backgroundImage: "url(assets/images/faqs/faq.jpg)" }}
              >
                <div className="headline-wrap style-three color-black">
                  <span className="marquee-wrap bg-white py-15">
                    <span className="marquee-inner left">
          ...
          <div
            className="lets-talk-area text-center bgs-cover pt-120 pb-130 rpy-90"
            style={{
              backgroundImage: "url(assets/images/background/tets-talk.jpg)",
            }}
          >
            <div className="container">
              <Link
