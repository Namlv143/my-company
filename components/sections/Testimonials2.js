                ...
                <Slider {...settings} className="testimonials-two-active">
                  <div className="testimonial-item">
                    ...
                    <div className="author-speech">
                      <p>
                        Our collaboration with the IT Supported team has
                        delivered results.Through the design, development and
                        app launch process the communication and guidance has
                  ...
                  <div className="testimonial-item">
                    ...
                    <div className="author-speech">
                      <p>
                        We need a responsive and secure web application fast.
                        The IT Supported team codesigned our product roadmap.
                        The execution was then win after win from our product
                  ...
                  <div className="testimonial-item">
                    ...
                    <div className="author-speech">
                      <p>
                      We required development of a hybrid web and mobile application for one of our european customers. The IT Supported team developed a secure and scalable solution without any delays. Happy customer!
                  ...
                  <div className="testimonial-item">
                    ...
                    <div className="author-speech">
                      <p>
                      Our company needed an Identity and Access Management capability for our customer & partner platform. IT Supported designed & implemented the Microsoft Azure Active Directory B2C solution. Remarkable!
                      </p>
                    </div>
                    <div className="testimonial-author">
                      <div className="author-image">
