              ...
              <div className="footer-widget widget-about wow fadeInUp delay-0-2s">
                ...
                <ul className="list-style-one">
                  ...
                  <li>
                    ...
                    <Link href="/callto:6845550102490">0978608188</Link>
                  </li>
                  <li>
              ...
              <div className="footer-widget widget-newsletter wow fadeInUp delay-0-5s">
                ...
                <form action="#">
                  ...
                  <label className="condition" htmlFor="condition">
                    <input id="condition" type="checkbox" required /> I agree to
                    all your terms and policies
                  </label>
                </form>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-10">
              <div className="copyright-text text-center mt-40 rmt-20 py-25">
                ...
                <Link href="/">Webtend</Link> . All Rights Reserved.
              </div>
            </div>
          </div>
        </div>
